...
LOGGER_ID = int(getenv("LOGGER_ID", -5264115011))
...
# ── Git / updates ──────────────────────────────────────────────────────────────
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/piyushcodings/tg-vc-music-player")
...
HELP_IMG_URL = "https://i.ibb.co/dJkrXQQd/x.jpg"
